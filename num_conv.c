...
int main()
{
    ...
    printf("\t\t====>ENTER THE USERNAME(upto 6 characters): <====\n");
	scanf("\t\t\t\t%s",user);  
    ...
    printf("\t\tWELCOME TO NUMBER SYSTEM CONVERSION %s\n\n",user);
...
else
{
	...
	{
		system("cls");
		printf("\n\n\t\t\t\t\t    =====>>0 ATTEMPTS LEFT<<=====\n\n\n\t\tYOU HAVE ENTERED THE WRONG PASSWORD FOR 3 TIMES PLEASE CLOSE THE TERMINAL AND OPEN AGAIN!!\n\n");
		printf("\n\t\t\t\t\t\t=====>THANKYOU<=====\n\n");
	exit(0);
	}
	{
